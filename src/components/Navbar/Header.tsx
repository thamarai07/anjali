        ...
        <div className="flex justify-between md:px-20 px-2 align-center items-center text-white">
          ...
          <div className="flex md:hidden">
            {isMenuOpen && NavOpen == true ? (
              <button aria-label="Close Menu" title="Close Menu" className="p-5 -mr-1 transition duration-200 rounded focus:outline-none focus:shadow-outline" onClick={HanldeSVGClosed}>
              ...
              ad == undefined &&
              cm == undefined && (
                <button aria-label="Open Menu" title="Open Menu" className="p-5 -mr-1 transition duration-200 rounded focus:outline-none focus:shadow-outline" onClick={HanldeSVGOpen}>
                  <svg className="w-5 text-gray-600" viewBox="0 0 24 24">
